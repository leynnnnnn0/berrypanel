...
class EnvironmentManager {
    ...
    public function save(Site $site,string $scope,array $variables): SiteEnvironment {
        ...
        // Do not change mode or ACLs here. Hosted PHP-FPM and Supervisor run as
        // different Linux users and must retain their explicitly granted read access.
        File::put($directory.'/.env',$content,true);
