...
class RestrictedCommandExecutor {
 ...
 'php artisan migrate'=>['php','artisan','migrate'],'php artisan migrate --force'=>['php','artisan','migrate','--force'],'php artisan migrate:status'=>['php','artisan','migrate:status'],'php artisan cache:clear'=>['php','artisan','cache:clear'],'php artisan config:clear'=>['php','artisan','config:clear'],'php artisan route:clear'=>['php','artisan','route:clear'],'php artisan view:clear'=>['php','artisan','view:clear'],'php artisan optimize'=>['php','artisan','optimize'],'php artisan queue:restart'=>['php','artisan','queue:restart'],'php artisan reverb:restart'=>['php','artisan','reverb:restart'],'php artisan schedule:list'=>['php','artisan','schedule:list'],
 ...
 'git status'=>['git','status'],'git log'=>['git','log','-n','30','--oneline'],'git pull'=>['git','pull','--ff-only','origin',$b],'git branch'=>['git','branch']];}
}
